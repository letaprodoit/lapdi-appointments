...
if ($mode == 'manage') 
{
	...
	$view->assign('appointments', $appointments);
	...
	$view->assign('user_list', $_user_list);
...
elseif ($mode == 'update' && !empty($_REQUEST['appointment_id'])) 
{
	...
	$view->assign('appointment_locations', $locations);
	$view->assign('appointment_statuses', Registry::get('tspa_appointment_statuses'));
	$view->assign('appointment', $appointment);
