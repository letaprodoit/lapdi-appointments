...
<div class="cm-tabs-content" id="tabs_content_{$id}">
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            {include file="addons/tsp_appointments/overrides/views/product_options/components/option_types.tpl"  name="option_data[option_type]" value=$option_data.option_type display="select" tag_id="elm_option_type_`$id`" check=true}
            </div>
        </div>
