...
{include file="common/mainbox.tpl" title="`$lang.tspa_editing_appointment`:&nbsp; `$appointment.user.lastname`, `$appointment.user.firstname`" content=$smarty.capture.mainbox select_languages=true}
