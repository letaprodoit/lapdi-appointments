...
<tr {cycle values="class=\"table-row\", "}>
	...
	<td class="nowrap">
		...
		{/capture}
		{include file="common_templates/table_tools_list.tpl" prefix=$id tools_list=$smarty.capture.tools_items href="appointments.update?appointment_id=`$id`" link_text=$lang.view}
	</td>
</tr>
{/foreach}
{else}
...
{if $appointments}
	{include file="common_templates/table_tools.tpl" href="#appointments"}
{/if}
...
{/capture}
{include file="common_templates/mainbox.tpl" title=$lang.tspa_appointments content=$smarty.capture.mainbox title_extra=$smarty.capture.title_extra}
